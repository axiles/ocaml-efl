...
let btn_clicked obj =
  ...
  | None ->
    ...
    Evas_object_smart.callback_add o Elm_sig.clicked inwin_hide;
    ...
    Evas_object_smart.callback_add o Elm_sig.clicked inwin_destroy;
...
let () =
  ...
  Evas_object_smart.callback_add o Elm_sig.clicked btn_clicked;
