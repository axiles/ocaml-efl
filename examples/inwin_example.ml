...
let btn_clicked obj =
  ...
  | None ->
    ...
    Evas_object_smart.callback_add o "clicked" inwin_hide;
    ...
    Evas_object_smart.callback_add o "clicked" inwin_destroy;

    Elm_box.pack_end (Elm_inwin.content_get iw) o

let btn_clicked_cb obj _ = btn_clicked obj

let win_del_cb obj _ =
  match !inwin with
  | Some iw ->
...
let () =
  ...
  Evas_object_smart.callback_add o "clicked" btn_clicked_cb;
