...
let win_action win box name cb =
    ...
    Elm_connect.Button.clicked btn cb
...
let main_win_del_cb obj =
  ...
  Elm_connect.Button.clicked btn yes_quit_cb;
  ...
  Elm_connect.Button.clicked btn no_quit_cb
...
let add_win_focus_cb win name =
  ...
  Elm_connect.Win.focused win cb
...
let () =
  ...
  Elm_connect.Win.delete_request win main_win_del_cb;
  ...
  Elm_box.pack_end bigbox o;
  Evas_object.show o;
  Elm_connect.Button.clicked o (force_focus_cb win2);
