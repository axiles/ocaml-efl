...
(* OASIS_START *)
(* DO NOT EDIT (digest: fa1d5984ab9be255c83eedb3d721a1fd) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("efl_doc", OCamlbuildDocPlugin.doc_build ".")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("efl_doc", OCamlbuildDocPlugin.doc_clean ".")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test4.ml"; });
               Executable
                 ({
                     cs_name = "test5";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test5.ml"; });
               Executable
                 ({
                     cs_name = "test6";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test6.ml"; });
               Executable
                 ({
                     cs_name = "test7";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test7.ml"; });
               Executable
                 ({
                     cs_name = "test8";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test8.ml"; });
               Executable
                 ({
                     cs_name = "test9";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test9.ml"; });
               Executable
                 ({
                     cs_name = "test10";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test10.ml"; });
               Executable
                 ({
                     cs_name = "test11";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test11.ml"; })
            ];
          plugins =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\005\188\148i\028\026\160\230\017!$\238dn\138\204";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
