...
{
        Evas_Object* obj = elm_fileselector_button_add(
...
{
        elm_fileselector_button_window_title_set(Evas_Object_val(v_obj),
                String_val(v_title));
        return Val_unit;
}
...
{
        elm_fileselector_button_window_size_set(Evas_Object_val(v_obj),
...
{
        Evas_Coord w, h;
        elm_fileselector_button_window_size_get(Evas_Object_val(v_obj), &w, &h);
...
{
        elm_fileselector_button_inwin_mode_set(Evas_Object_val(v_obj),
                Bool_val(v_flag));
        return Val_unit;
}
