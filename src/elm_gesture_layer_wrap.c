...
PREFIX value ml_elm_gesture_layer_double_tap_timeout_set(
        value v_obj, value v_x)
{
        elm_gesture_layer_double_tap_timeout_set((Evas_Object*) v_obj,
                Double_val(v_x));
        return Val_unit;
}

PREFIX value ml_elm_gesture_layer_double_tap_timeout_get(value v_obj)
{
        return copy_double(elm_gesture_layer_double_tap_timeout_get(
                (Evas_Object*) v_obj));
}

PREFIX value ml_elm_gesture_layer_tap_finger_size_set(value v_obj, value v_x)
{
        elm_gesture_layer_tap_finger_size_set((Evas_Object*) v_obj,
                Int_val(v_x));
        return Val_unit;
}

PREFIX value ml_elm_gesture_layer_tap_finger_size_get(value v_obj)
{
        return Val_int(elm_gesture_layer_tap_finger_size_get(
                (Evas_Object*) v_obj));
}
