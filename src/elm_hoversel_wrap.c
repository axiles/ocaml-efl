...
{
        Evas_Object* obj = elm_hoversel_add(Evas_Object_val(v_parent));
...
{
        elm_hoversel_horizontal_set(Evas_Object_val(v_box), Bool_val(v_flag));
        return Val_unit;
}

PREFIX value ml_elm_hoversel_horizontal_get(value v_obj)
{
        return Val_bool(elm_hoversel_horizontal_get(Evas_Object_val(v_obj)));
}

PREFIX value ml_elm_hoversel_hover_parent_set(value v_obj, value v_parent)
{
        elm_hoversel_hover_parent_set(Evas_Object_val(v_obj),
...
{
        return copy_Evas_Object(elm_hoversel_hover_parent_get(
                Evas_Object_val(v_obj)));
}

PREFIX value ml_elm_hoversel_hover_begin(value v_obj)
{
        elm_hoversel_hover_begin(Evas_Object_val(v_obj));
        return Val_unit;
}

PREFIX value ml_elm_hoversel_hover_end(value v_obj)
{
        elm_hoversel_hover_end(Evas_Object_val(v_obj));
        return Val_unit;
}

PREFIX value ml_elm_hoversel_expanded_get(value v_obj)
{
        return Val_bool(elm_hoversel_expanded_get(Evas_Object_val(v_obj)));
}

PREFIX value ml_elm_hoversel_clear(value v_obj)
{
        elm_hoversel_clear(Evas_Object_val(v_obj));
        return Val_unit;
}
        ...
        value v_obj, value v_label, value v_icon, value v_func, value v_unit)
{
        ...
        Elm_Object_Item* item = elm_hoversel_item_add(Evas_Object_val(v_obj),
