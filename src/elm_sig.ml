...
let color_item_selected = create_item "color,item,selected"
let color_item_longpressed = create_item "color,item,longpressed"
...
let display_changed = create_unit "display,changed"
let directory_open = create_string "directory,open"
let dismissed = create_unit "dismissed"
let _done = create_string_opt "done"
let download_error = create "download,error" Elm_photocam.error_of_ptr
let download_progress = create "download,progress" Elm_photocam.progress_of_ptr
...
let image_deleted = create_unit "image,deleted"
let image_resized = create_unit "image,resized"
let index_update = create_unit "index,update"
let indicator_prop_changed = create_unit "indicator,prop,changed"
let info_clicked = create_unit "info,clicked"
let inputmethod_changed = create_bool "inputmethod,changed"
let ioerr = create_unit "ioerr"
let item_added = create_unit "item,added"
let item_clicked = create_unit "item,clicked"
let item_deleted = create_unit "item,deleted"
let item_focused = create_unit "item,focused"
let item_reorder_anim_start = create_item "item,reorder,anim,start"
let item_reorder_anim_stop = create_item "item,reorder,anim,stop"
let item_selected = create_unit "item,selected"
let item_unfocused = create_unit "item,unfocused"
...
let load = create_unit "load"
let load_detail = create_unit "load,detail"
...
let loaded_detail = create_unit "loaded,detail"
...
let next_clicked = create_unit "next,clicked"
let normal = create_unit "normal"
let overflowed = create_unit "overflowed"
let overlay_clicked = create_unit "overlay,clicked"
let pause_clicked = create_unit "pause,clicked"
let play_clicked = create_unit "play,clicked"
...
let prev_clicked = create_unit "prev,clicked"
...
let rewind_clicked = create_unit "rewind,clicked"
...
let scroll_down = create_unit "scroll,down"
let scroll_left = create_unit "scroll,left"
let scroll_page_changed = create_unit "scroll,page,changed"
let scroll_right = create_unit "scroll,right"
let scroll_up = create_unit "scroll,up"
...
let stop_clicked = create_unit "stop,clicked"
...
let transition_end = create_item "transition,end"
