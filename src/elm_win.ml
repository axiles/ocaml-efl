...
external focus_highlight_animate_set : Evas.obj -> bool -> unit =
  "ml_elm_win_focus_highlight_animate_set"

external focus_highlight_animate_get : Evas.obj -> bool =
  "ml_elm_win_focus_highlight_animate_get"
