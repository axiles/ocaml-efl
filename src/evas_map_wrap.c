...
{
        evas_map_util_points_populate_from_object_full(Evas_Map_val(v_m),
...
{
        evas_map_util_points_populate_from_object(Evas_Map_val(v_m),
...
{
        evas_map_util_points_populate_from_geometry(Evas_Map_val(v_m),
...
{
        evas_map_util_points_color_set(Evas_Map_val(v_m), Int_val(v_r),
...
{
        evas_map_util_rotate(Evas_Map_val(v_m), Double_val(v_d), Int_val(v_x),
                Int_val(v_y));
        return Val_unit;
}
...
{
        evas_map_util_zoom(Evas_Map_val(v_m), Double_val(v_zx),
                Double_val(v_zy),
...
PREFIX value ml_evas_map_util_3d_rotate_native(
        ...
        value v_cz)
{
        evas_map_util_3d_rotate(Evas_Map_val(v_m), Double_val(v_dx),
...
{
        evas_map_util_quat_rotate(Evas_Map_val(v_m), Double_val(v_qx),
...
{
        evas_map_util_3d_lighting(Evas_Map_val(v_m), Int_val(v_lx),
                Int_val(v_ly),
...
{
        evas_map_util_3d_perspective(Evas_Map_val(v_m), Int_val(v_px),
...
{
        return Val_bool(evas_map_util_clockwise_get(Evas_Map_val(v_m)));
}
...
{
        evas_map_smooth_set(Evas_Map_val(v_m), Bool_val(v_flag));
        return Val_unit;
}

PREFIX value ml_evas_map_smooth_get(value v_m)
{
        return Val_bool(evas_map_smooth_get(Evas_Map_val(v_m)));
}

PREFIX value ml_evas_map_alpha_set(value v_m, value v_flag)
{
        evas_map_alpha_set(Evas_Map_val(v_m), Bool_val(v_flag));
        return Val_unit;
}

PREFIX value ml_evas_map_alpha_get(value v_m)
{
        return Val_bool(evas_map_alpha_get(Evas_Map_val(v_m)));
}

PREFIX value ml_evas_map_dup(value v_m)
{
        return copy_Evas_Map(evas_map_dup(Evas_Map_val(v_m)));
}

PREFIX value ml_evas_map_free(value v_m)
{
        evas_map_free(Evas_Map_val(v_m));
        return Val_unit;
}

PREFIX value ml_evas_map_count_get(value v_m)
{
        return Val_int(evas_map_count_get(Evas_Map_val(v_m)));
}

PREFIX value ml_evas_map_point_coord_set(
        value v_m, value v_i, value v_x, value v_y, value v_z)
{
        evas_map_point_coord_set(Evas_Map_val(v_m), Int_val(v_i), Int_val(v_x),
...
{
        Evas_Coord x, y, z;
        evas_map_point_coord_get(Evas_Map_val(v_m), Int_val(v_i), &x, &y, &z);
...
{
        evas_map_point_image_uv_set(Evas_Map_val(v_m), Int_val(v_i),
...
PREFIX value ml_evas_map_point_image_uv_get(value v_m, value v_i)
{
        ...
        CAMLlocal1(v_r);
        double u, v;
        evas_map_point_image_uv_get(Evas_Map_val(v_m), Int_val(v_i), &u, &v);
        v_r = caml_alloc(2, 0);
...
{
        evas_map_point_color_set(Evas_Map_val(v_m), Int_val(v_i), Int_val(v_r),
                Int_val(v_g), Int_val(v_b), Int_val(v_a));
        return Val_unit;
}
...
{
        int r, g, b, a;
        evas_map_point_color_get(Evas_Map_val(v_m), Int_val(v_i), &r, &g, &b,
                &a);
