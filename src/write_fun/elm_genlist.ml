...
let item_scrollto_type = simple_ty "Elm_Genlist" "Item_Scrollto_Type"
let item_field_type = simple_ty "Elm_Genlist" "Item_Field_Type"
let item_type = simple_ty "Elm_Genlist" "Item_Type"

let funs = [
  simple_unit "clear" [evas_object];
  prop "multi_select" bool;
  prop "multi_select_mode" bool;
  prop "mode" Elm_list.mode;
  ...
  simple "item_subitems_count" [elm_object_item] int;
  ...
  simple_unit "item_fields_update"
    [elm_object_item; safe_string; item_field_type];
  ...
  simple "item_type_get" [elm_object_item] item_type;
